...
mu_p = Mu_p[3]
#load baselines
b_mse_sys_elo = readRDS("output/b1_sys_e3.RDS")
b_mse_elo = readRDS("output/b1_e3.RDS")
...
#saving the output
saveRDS(res_sys_elo, "output/res1_sys_e3.RDS")
saveRDS(res_elo, "output/res1_e3.RDS")
