...
mu_p = Mu_p[2]
#load baselines
b_mse_sys_elo = readRDS("output/b1_sys_e2.RDS")
b_mse_elo = readRDS("output/b1_e2.RDS")
...
#saving the output
saveRDS(res_sys_elo, "output/res1_sys_e2.RDS")
saveRDS(res_elo, "output/res1_e2.RDS")
