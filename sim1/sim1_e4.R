...
mu_p = Mu_p[4]
#load baselines
b_mse_sys_elo = readRDS("output/b1_sys_e4.RDS")
b_mse_elo = readRDS("output/b1_e4.RDS")
...
#saving the output
saveRDS(res_sys_elo, "output/res1_sys_e4.RDS")
saveRDS(res_elo, "output/res1_e4.RDS")
