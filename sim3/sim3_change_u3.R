...
for(us in 1:length(Student_urn_size)){
  ...
  res_urnings[us, "bias"] = mean(r$bias_v[,401:501])
...
saveRDS(res_urnings, "output/res3_u3.RDS")
saveRDS(res_bias, "output/res3_bias_u3.RDS")
saveRDS(res_var, "output/res3_var_u3.RDS")
